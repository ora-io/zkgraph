...
export function testBigIntMath(): void {
  ...
  result = a.times(b);
  assert(result.toString() === BigInt.fromString("50").toString(), "Failed: times()");
  ...
  b = BigInt.fromString("999999");
  result = a.times(b);
  assert(result.toString() === BigInt.fromString("999999").toString(), "Failed: times()");
  ...
  result = a.div(b);
  assert(result.toString() === BigInt.fromString("20").toString(), "Failed: div()");

  a = BigInt.fromString("-100");
  b = BigInt.fromString("7");
  result = a.div(b);
  assert(result.toString() === BigInt.fromString("-14").toString(), "Failed: div()");
  ...
  b = BigInt.fromString("1");
  result = a.div(b);
  assert(result.toString() === BigInt.fromString("999999").toString(), "Failed: div()");

  a = BigInt.fromString("1");
  b = BigInt.fromString("999999");
  result = a.div(b);
  assert(result.toString() === BigInt.fromString("0").toString(), "Failed: div()");

  // mod()
  a = BigInt.fromString("100");
  b = BigInt.fromString("7");
  result = a.mod(b);
  assert(result.toString() === BigInt.fromString("2").toString(), "Failed: mod()");
  ...
  b = BigInt.fromString("1");
  result = a.mod(b);
  assert(result.toString() === BigInt.fromString("0").toString(), "Failed: mod()");

  a = BigInt.fromString("1");
  b = BigInt.fromString("999999");
  result = a.mod(b);
  assert(result.toString() === BigInt.fromString("1").toString(), "Failed: mod()");
  ...
  a = BigInt.fromString("5");
  result = a.neg();
  assert(result.toString() === BigInt.fromString("-5").toString(), "Failed: neg()");
  ...
  result = a.neg();
  assert(result.toString() === BigInt.fromString("0").toString(), "Failed: neg()");
