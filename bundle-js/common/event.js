...
export class Event {
  ...
  prettyPrint(prefix = "", withoffsets = true) {
    console.log('>>')
    console.log(prefix, "|--addr:", toHexString(this.address), withoffsets?this.address_offset:'');
    ...
    console.log(prefix, "|--data:", toHexString(this.data), withoffsets?this.data_offset:'');
  }
  ...
  static fromRlp(rlpdata) {
    ...
    return new Event(address, topics, data, address_offset, topics_offset, data_offset);
  }
